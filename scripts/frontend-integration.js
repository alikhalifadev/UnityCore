 ...
 * This file demonstrates how to integrate Unitycore with a web frontend
 */

// For React/Vue/Angular applications
export class UnitycoreClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new UnitycoreClient(provider, contractAddress);
